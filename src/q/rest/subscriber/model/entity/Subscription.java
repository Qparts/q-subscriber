...
public class Subscription {
    @Id
    @SequenceGenerator(name = "sub_subscription_id_seq_gen", sequenceName = "sub_subscription_id_seq", initialValue=1, allocationSize = 1)
    @GeneratedValue(strategy = GenerationType.AUTO, generator = "sub_subscription_id_seq_gen")
    private int id;
